...
export default function Preferences() {
  ...
  const { userName, userEmail,userContactNumber, livingSpace,ownedPets  } = useLocalSearchParams(); // Retrieves 'userName' from search params
  ...
  const handleFindPet = () => router.push({ 
