...
export default function Lifestyle() {
  ...
  const { userName, userEmail,userContactNumber } = useLocalSearchParams(); // Retrieves 'userName' from search params
  ...
  const handleProceed = () => {
    if (livingSpace && ownedPets !== null) {
      ...
      params: { userName, userEmail,userContactNumber, livingSpace, ownedPets }, // Pass 'userName' from Options to Lifestyle
    });
    } else {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.backButtonContainer}>
          ...
          <Text style={styles.greetingText}>Hello {userContactNumber || "User"},</Text>
